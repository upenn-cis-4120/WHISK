...
const events = [
  {
    ...
    groceries: [
      { id: 1, name: "Rice Flour", quantity: "1.5 lb", have: true },
      { id: 2, name: "Watermelon", quantity: "1 unit", have: true },
      { id: 3, name: "Paprika", quantity: "3 tbsp", have: false },
      { id: 4, name: "Apples", quantity: "12 unit", have: false },
      { id: 5, name: "Cinnamon", quantity: "4 tbsp", have: false },
    ],
    expenses: {
      total: 60,
      perPerson: 20,
      breakdown: [
        { name: "Eric", amount: 0, paid: true },
        { name: "Rohan", amount: 0, paid: true },
        { name: "Simon", amount: 13, paid: false },
        { name: "Vedansh", amount: 27, paid: false },
        { name: "Logan", amount: 20, paid: false },
      ],
    },
    recipes: [
      {
